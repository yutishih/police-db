<script>
    ...
    import { dictLight2Color, colorOrange, colorGreen, colorRed } from '../constants/constants.js'
        ...
        methods:{
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: [1, 1, 1],
                                backgroundColor: [this.colorHsdRight, this.colorHsdBottom, this.colorHsdLeft]
                            }
                        ]
                    },
                    options: {
                        ...
                        onComplete: function(animation) {
                            ...
                            var pieRadius = Math.min((chartInstance.chartArea.right - chartInstance.chartArea.left) / 2, (chartInstance.chartArea.bottom - chartInstance.chartArea.top) / 2);
                        ...
                        onClick: function(event, elements) {
                            if (elements && elements.length > 0) {
                                ...
                                if (index === 0) {
                                    // 工安
                                    self.modeOfPieChart = ['保命條款', '不安全行為', '不安全環境', '職災失能']
                                    self.mode = 'WorkerSafety'
                                    self.btnClickMode = true
                                }
                                else if (index === 1) {
                                    // 環保
                                    self.modeOfPieChart = ['水汙染', '空汙', '事業廢棄物', '毒化物']
                                    self.mode = 'EnvironmentalFriendly'
                                    self.btnClickMode = true
                                } 
                                else if (index === 2) {
                                    // 衛生
                                    self.modeOfPieChart = ['母性保護', '關懷率', '健康促進', '職業病預防']
            ...
            colorHealthSafety(){
                ...
                return new Promise((resolve) => {
                    ...
                    this.colorUpperLeftHealthSafety = dictLight2Color[this.dictHealthSafety['numberPeopleCareOf']['M-finalStatus']]
                    this.colorUpperRightHealthSafety = dictLight2Color[this.dictHealthSafety['girlProtection']['M-finalStatus']]
                    this.colorBottomLeftHealthSafety = dictLight2Color[this.dictHealthSafety['healthPromotion']['M-finalStatus']]
                    this.colorBottomRightHealthSafety = dictLight2Color[this.dictHealthSafety['specialWork']['M-finalStatus']]
            ...
            colorEnvironmentalFriendly(){
                ...
                return new Promise((resolve) => {
                    ...
                    this.colorUpperLeftEnvironmentalFriendly = dictLight2Color[this.dictEnvironmentalFriendly['airPollution']['finalStatus']]
                    this.colorUpperRightEnvironmentalFriendly = dictLight2Color[this.dictEnvironmentalFriendly['waterPollution']['finalStatus']]
                    this.colorBottomRightEnvironmentalFriendly = dictLight2Color[this.dictEnvironmentalFriendly['poison']['finalStatus']]
                    this.colorBottomLeftEnvironmentalFriendly = dictLight2Color[this.dictEnvironmentalFriendly['industrialWaste']['finalStatus']]
                    this.colorBarEnvironmentalFriendly.push(this.colorUpperLeftEnvironmentalFriendly)
                    this.colorBarEnvironmentalFriendly.push(this.colorUpperRightEnvironmentalFriendly)
                    this.colorBarEnvironmentalFriendly.push(this.colorBottomRightEnvironmentalFriendly)
                    this.colorBarEnvironmentalFriendly.push(this.colorBottomLeftEnvironmentalFriendly)

                    for(const key in this.dictEnvironmentalFriendly){
                        if (this.dictEnvironmentalFriendly[key]['finalStatus']=='黃' && this.colorHsdBottom == colorGreen){
                            this.colorHsdBottom = colorOrange
                        }
                        else if (this.dictEnvironmentalFriendly[key]['finalStatus']=='紅' && (this.colorHsdBottom == colorGreen || this.colorHsdBottom == colorOrange)){
            ...
            colorWorkerSafety(){
                ...
                return new Promise((resolve) => {
                    ...
                    this.colorUpperLeftWorkerSafety = dictLight2Color[this.dictWorkerSafety['lifeClause']['M']['finalStatus']]
                    this.colorUpperRightWorkerSafety = dictLight2Color[this.dictWorkerSafety['unsafeBehavior']['M']['finalStatus']]
                    this.colorBottomRightWorkerSafety = dictLight2Color[this.dictWorkerSafety['occupationalDisaster']['thisYear']['finalStatus']]
                    this.colorBottomLeftWorkerSafety = dictLight2Color[this.dictWorkerSafety['unsafeEnvironment']['M']['finalStatus']]
                    ...
                    for(const key in this.dictWorkerSafety){
                        if (this.dictWorkerSafety[key]['M']['finalStatus']=='黃' && this.colorHsdRight == colorGreen){
                            this.colorHsdRight = colorOrange
                        }
                        else if (this.dictWorkerSafety[key]['M']['finalStatus']=='紅' && (this.colorHsdRight == colorGreen || this.colorHsdRight == colorOrange)){
        ...
        <div v-if="btnClickMode==false">
            ...
            <div class="center-row">
                ...
                <div class="text-center">
                    <div class="section-title">
                        <label style="font-family: Microsoft JhengHei; font-size: 36px; text-align: center; font-weight: bold;">HSD公共安全指標</label><br><br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="section-title">
                            <label style="font-family: Microsoft JhengHei; font-size: 36px; text-align: center;">衛生</label><br><br><br>
                        </div>
                    </div>
                    <MidPieChart refs="refsMidPieChart"
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="section-title">
                            <label style="font-family: Microsoft JhengHei; font-size: 36px; text-align: center;">環保</label><br><br><br>
                        </div>
                    </div>
                    <MidPieChart refs="refsMidPieChart"
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="section-title">
                            <label style="font-family: Microsoft JhengHei; font-size: 36px; text-align: center;">工安</label><br><br><br>
                        </div>
                    </div>
                    <MidPieChart refs="refsMidPieChart"
                        ...
                        :modeOfPieChart="['保命條款', '不安全行為', '不安全環境', '職災失能']">
                    </MidPieChart>
                </div>
            </div>
        </div>

        <button type="button" class="btn-lg" v-bind:onclick="change2importExcel" style="opacity: 0;">匯入資料</button>
        
        <div v-if="btnClickMode==true">
            <div v-if="mode=='HealthSafety'">
                <pieChartView refs="refspieChartView"
            ...
            <div v-else-if="mode=='EnvironmentalFriendly'">
                <lineChartView refs="refsLineChartView"
                    :modeOfPieChart="modeOfPieChart"
